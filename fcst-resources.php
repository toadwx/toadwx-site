<html>
    ...
    <body>
        ...
        <div class="main">
          ...
          <h3>Forecasting Resources</h3>
          
          <h4>Local Forecast Maps and Data</h4>
          <ul class="list img-list">
            <li>
              <a href="https://www.weather.gov/gsp" class="inner" target="_blank">
                <div class="li-img">
                  <img src="images/resource-thumbnails/nws-gsp.png" alt="NWS GSP" />
                </div>
                <div class="li-text">
